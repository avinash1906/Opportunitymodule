...
import com.Vtiger.ObjectRepLib.Opp31;
import com.Vtiger.ObjectRepLib.Opp33;
import com.Vtiger.genericlib.BaseClass;
import com.Vtiger.genericlib.FileLib;
import com.Vtiger.genericlib.WebdriverCommonUtile;

public class OpportunityModuleTC33 extends BaseClass {
	// search opportunity by opportunity name
	// login to Vtiger CRM

	@Test

	public void serachOpportunityName() throws Throwable {
		/*
		 * // login to Vtiger CRM
		 * 
		 ...
		 * FirefoxDriver()
		 * ; } else if (BROWSER.equals("chrome")) { driver = new
		 * ChromeDriver();
		 * 
		...
		Opp33 op = PageFactory.initElements(BaseClass.driver, Opp33.class);
		...
		op.getSearchBox().sendKeys("cuscall");

		// enter opportunity no
		WebElement wb = op.getSearchField();
		Select sel = new Select(wb);

		// select opportunity no from dropdown "in"
		sel.selectByVisibleText("Opportunity Name");
