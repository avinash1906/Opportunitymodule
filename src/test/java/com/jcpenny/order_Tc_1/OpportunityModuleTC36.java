...
public class OpportunityModuleTC36 extends BaseClass {
	// search opportunity by opportunity lead source
	@Test
	public static void serachOppLeadSource() throws Throwable {
		...
		op.getSearchBox().sendKeys("None");

		// enter opportunity lead source
		WebElement wb = op.getSearchField();
		Select sel = new Select(wb);
		// select opportunity no from dropdown "in"
		sel.selectByVisibleText("Lead Source");
